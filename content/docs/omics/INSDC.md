...
- __Runs__ - Metadata objects directly associated with the raw read data files
...
{{< hint info >}}
__Data and Metadata__  
_Run_ and _Analysis_ objects are the only two object types which have data files
associated with them rather than just metadata.
{{< /hint >}}
